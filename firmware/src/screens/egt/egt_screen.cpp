...
//   "°C"        — italic font, right side next to the large digits
...
// =============================================================================
// Pajero splash logo — 118 × 15 px, stored in flash (shared with boost screen)
// =============================================================================
...
// bottom over ~1.2 seconds.  Called once during egtScreen_init().  Provides
...
static void _drawStaticComponents() {
    ...
    _display->setCursor(97, 30);
    _display->print((char)247);                 // ° symbol
    _display->setCursor(109, 30);
    _display->print("C");
